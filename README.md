...
Tài khoản này được tạo ra với tôn chỉ duy nhất: **Cống hiến cho cộng đồng thông qua tiện ích**. Trong một shipdom, vì không viết được fanfiction hay vẽ fanart, tác giả chọn lập trình để phục vụ cộng đồng, không chỉ PhaiRice nói riêng mà toàn thể người dùng AO3 nói chung. Bản thân nền tảng vốn giữ cấu trúc rất tối giản và đôi khi thiếu đi những tiện ích cần thiết. Vì vậy, các công cụ tại đây ra đời nhằm bổ sung và hoàn thiện những thiếu sót đó.

## Định hướng

Các tiện ích trong đây được xây dựng có các đặc tính chung:
* **Chuyên môn cốt lõi:** Tập trung tối đa vào tối ưu hóa giao diện (**UI**) và trải nghiệm người dùng (**UX**), cái mà chúng ta hay gọi là Frontend.
...
* **Ảnh đại diện:** Ảnh đại diện là commission tác giả đặt hàng riêng, vẽ bởi Partry (Phát Thái).
